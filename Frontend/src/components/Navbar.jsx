    ...
    <nav className="bg-gray-900 text-white px-8 md:px-16 lg:px-24">
      <div className="container py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex justify-center flex-1 space-x-10">
          ...
          {/* <a href="#service" className="text-white hover:text-green-400 transition duration-300">Services</a> */}
      ...
      <div className={`md:hidden ${isMenuOpen ? 'flex' : 'hidden'} flex-col items-center bg-gray-900 py-4 space-y-6`}>
        ...
        {/* <a href="#service" className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-gray-400 transition duration-300">Services</a> */}
